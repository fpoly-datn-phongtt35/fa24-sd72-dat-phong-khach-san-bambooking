  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const phuThuItems = checkData.filter(item => {
        ...
        console.log('SoLuongThucTe:', item.soLuongThucTe, 'SoLuongTieuChuan:', material ? material.soLuongTieuChuan : 'Không tìm thấy vật tư');
      ...
      for (const item of phuThuItems) {
        ...
        try {
          ...
          console.log(`Đã thêm phụ thu: ${tenPhuThu}, Tổng tiền: ${tienPhuThu}`);
        } catch (error) {
