...
import { getHoaDonById, createThanhToan, updateThanhToan } from '../../services/ThanhToanService';
    ...
    useEffect(() => {
        const fetchHoaDonAndCreateThanhToan = async () => {
            try {
                ...
                setError('Không thể tải thông tin hóa đơn hoặc tạo thanh toán. Vui lòng thử lại.');
            }
        };
                ...
                {error ? (
                    ...
                    <Stack spacing={4}>
                        <ToggleButtonGroup
                            ...
                            exclusive
                            onChange={(e, value) => value !== null && setPhuongThucThanhToan(value)}
                            fullWidth
                            color="primary"
                        >
                            ...
                            hoaDon ? (
                                <Paper elevation={2} sx={{ paddingLeft: 13, paddingTop: 5, paddingBottom: 4, backgroundColor: '#f9f9f9' }}>
                                    <Stack spacing={3}>
                                        ...
                                        {hoaDon.tongTien === 0 ? (
                                            <Typography color="primary">Không cần thanh toán thêm do đã thanh toán trước.</Typography>
                                        ) : (
