                            ...
                            {taiKhoan.length > 0 ? (
                                taiKhoan.map((taiKhoan) => (
                                    <tr key={taiKhoan.id}>
                                        ...
                                        {/* Hiển thị trạng thái dưới dạng văn bản dựa trên giá trị boolean */}
                                        <td>{taiKhoan.trangThai ? "Active" : "Inactive"}</td>
                                        <td>
                                            <button
                                                className="btn btn-info me-2"
                                                onClick={() => handleDetailClick(taiKhoan)}
                                            >
                                                Detail
                                            </button>
                                            <button
                                                className="btn btn-danger"
                                                onClick={() => handleDeleteTaiKhoan(taiKhoan.id)}
                                            >
                                                Delete
                                            </button>
                                        </td>
