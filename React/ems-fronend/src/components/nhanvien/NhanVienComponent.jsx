...
//         // Kiểm tra xem ngày tạo và ngày sửa có hợp lệ không, nếu có, chuyển đổi thành ISO 8601
...
//                                 <input type="text" name='ho' value={ho} className='form-control'
//                                 onChange={(e) => setHo(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Tên</label>
//                                 <input type="text" name='ten' value={ten} className='form-control'
//                                 onChange={(e) => setTen(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Giới tính</label>
//                                 <input type="text" name='gioiTinh' value={gioiTinh} className='form-control'
//                                 onChange={(e) => setGioiTinh(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Quốc gia</label>
//                                 <input type="text" name='quocGia' value={quocGia} className='form-control'
//                                 onChange={(e) => setQuocGia(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Số điện thoại</label>
//                                 <input type="text" name='sdt' value={sdt} className='form-control'
...
//                                 <input type="date" name='ngayTao' value={ngayTao} className='form-control'
//                                 onChange={(e) => setNgayTao(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Ngày sửa</label>
//                                 <input type="date" name='ngaySua' value={ngaySua} className='form-control'
//                                 onChange={(e) => setNgaySua(e.target.value)}/>
//                             </div>

//                             <div className='form-group mb-2'>
//                                 <label className='form-lable'>Trạng thái</label>
//                                 <input type="text" name='trangThai' value={trangThai} className='form-control'
