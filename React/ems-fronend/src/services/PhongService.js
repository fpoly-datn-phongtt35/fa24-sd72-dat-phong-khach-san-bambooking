...
const apiPhongDangDat = "http://localhost:8080/phong/phong-dang-dat";
const apiHuyPhongDangDat = "http://localhost:8080/phong/huy-phong-dang-dat";
...
export const createPhong = (phong) =>
  authorizedAxiosInstance.post(apiPhong, phong);
export const getOnePhong = (phongId) =>
  authorizedAxiosInstance.get(apiPhong + "/" + phongId);
export const updatePhong = (phongId, phong) =>
  authorizedAxiosInstance.put(apiPhong + "/" + phongId, phong);
...
export const setPhongDangDat = (idPhong) => {
  return authorizedAxiosInstance.get(apiPhongDangDat, {
    params: {
      idPhong: idPhong,
    },
  });
...
export const huyPhongDangDat = (idPhong) => {
  return authorizedAxiosInstance.get(apiHuyPhongDangDat, {
    params: {
      idPhong: idPhong,
    },
  });
