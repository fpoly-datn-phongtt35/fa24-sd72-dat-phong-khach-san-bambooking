...
CREATE TABLE loai_phong (
  ...
  dien_tich INT,
  so_khach_tieu_chuan INT,
  so_khach_toi_da INT,
  tre_em_tieu_chuan INT,
  tre_em_toi_da INT,
  don_gia DECIMAL(18,2),
  phu_thu_nguoi_lon DECIMAL(18,2),
  phu_thu_tre_em DECIMAL(18,2),
  mo_ta NVARCHAR(255),
  trang_thai BIT,
);
...
INSERT INTO loai_phong (ma_loai_phong, ten_loai_phong, dien_tich, so_khach_tieu_chuan, so_khach_toi_da, tre_em_tieu_chuan, tre_em_toi_da, don_gia, phu_thu_nguoi_lon, phu_thu_tre_em, mo_ta, trang_thai)
VALUES 
    ('LP001', N'Phòng đơn', 25, 1, 1, 0, 0, 500000, 100000, 50000, N'Phòng dành cho một khách.', 1),
    ('LP002', N'Phòng đôi', 35, 2, 2, 1, 1, 800000, 150000, 75000, N'Phòng dành cho hai khách.', 1),
    ('LP003', N'Phòng gia đình', 60, 4, 4, 2, 2, 1200000, 200000, 100000, N'Phòng rộng rãi dành cho gia đình.', 1);

-- Chèn dữ liệu vào bảng vat_tu_loai_phong
