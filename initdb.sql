...
VALUES 
(1, '123456789012', 'Tran', 'Minh', 'Nam', '45 Le Loi, Quan 1, TP.HCM', '0935123456', 'minh.tran@example.com', GETDATE(), GETDATE(), 1),
(2, '987654321098', 'Pham', 'Thi Lan', 'Nu', '78 Nguyen Hue, Hue', '0987654321', 'lan.pham@example.com', GETDATE(), GETDATE(), 1);

INSERT INTO khach_hang (id_tai_khoan, cmnd, ho, ten, gioi_tinh, dia_chi, sdt, email, ngay_tao, ngay_sua, trang_thai)
VALUES 
(3, '456789123456', 'Le', 'Hoang Anh', 'Nam', '123 Ly Thuong Kiet, Da Nang', '0912345678', 'anh.le@example.com', GETDATE(), GETDATE(), 1),
(4, '789123456789', 'Nguyen', 'Thanh Tung', 'Nam', '56 Tran Hung Dao, Ha Noi', '0978765432', 'tung.nguyen@example.com', GETDATE(), GETDATE(), 1);
