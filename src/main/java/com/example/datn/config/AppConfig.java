...
public class AppConfig {
    ...
    "/api/hoa-don/**","/api/dp/**","/api/tra-cuu/**","/danh-gia/**","/api/dich_vu/**", "/test-domain", "/api/v1/payment/**", "/api/v1/payment/webhook", "/dat-phong/danh-sach-da-huy"}; // Những đường dẫn không yêu cầu xác thực
