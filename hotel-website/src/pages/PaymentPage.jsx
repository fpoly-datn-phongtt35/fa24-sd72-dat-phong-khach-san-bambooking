...
//   // Nếu không có thông tin đặt phòng, quay lại trang đặt phòng
//   if (!room) {
//     navigate('/booking');
//     return null;
//   }
...
//     navigate('/confirmation'); // Chuyển hướng đến trang xác nhận đặt phòng
//   };
...
//             <p><strong>Giá Phòng:</strong> ${room.price} / đêm</p>
...
//               </ul>
//             ) : (
//               <p>Không có dịch vụ bổ sung nào được chọn.</p>
//             )}
//           </div>
